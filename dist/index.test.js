...
const activeSpreadsheet = globalThis.SpreadsheetApp.getActive();
...
describe('index.ts run() integration tests', () => {
    ...
    test('successfully processes feeds, triggers discord webhook, and updates feed sheet row', () => {
        ...
        const discordRequestPayload = JSON.parse((_d = (_c = (_b = (_a = mockFetcher.requests[DISCORD_WEBHOOK]) === null || _a === void 0 ? void 0 : _a[0]) === null || _b === void 0 ? void 0 : _b.req) === null || _c === void 0 ? void 0 : _c.payload) !== null && _d !== void 0 ? _d : '{}');
