...
describe('discord.ts applyLimits unit tests', () => {
    test('trims content if it exceeds CONTENT_LENGTH limit', () => {
        ...
        assert.strictEqual((_a = payloads[0].content) === null || _a === void 0 ? void 0 : _a.length, 1800);
        assert.strictEqual((_b = payloads[0].content) === null || _b === void 0 ? void 0 : _b.endsWith('...'), true);
    });
